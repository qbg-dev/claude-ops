# Show HN: boring — agent harness infrastructure for Claude Code

**Title**: Show HN: boring — persistent agent harnesses built on Claude Code's native hooks
...
boring solves this by sitting on top of Claude Code's built-in hook system. Four hooks—PreToolUse, PostToolUse, Stop, UserPromptSubmit—become the control plane:
...
This repo's own docs are maintained by an oss-steward agent running on boring.

GitHub: https://github.com/qbg-dev/boring
Getting started: https://github.com/qbg-dev/boring/blob/main/docs/getting-started.md
