...
Use the templates at `~/.claude-fleet/templates/harness.md.tmpl` and `goal.md.tmpl`. The scaffold (`~/.claude-fleet/scripts/scaffold.sh`) produces them automatically.
